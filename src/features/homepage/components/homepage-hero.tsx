    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(180deg, rgba(0,16,26,0.55) 0%, rgba(0,16,26,0.80) 100%)' }}
        />
      </div>
          ...
          <div className="flex flex-col" style={{ gap: 16 }}>
            ...
            <div className="flex flex-col" style={{ gap: 8 }}>
              <div className="flex flex-row items-center" style={{ gap: 60 }}>
                <span
                  className={montserrat.className}
                  style={{ fontSize: 16, fontWeight: 700, lineHeight: '24px', color: '#FFFFFF', letterSpacing: '0.5px' }}
                >
                  Tháng 12/2025
                </span>
                <span
          ...
          <div className="flex flex-row flex-wrap items-center" style={{ gap: 40 }}>
            ...
            >
              ...
              <div className="relative" style={{ width: 24, height: 24, flexShrink: 0 }}>
                <Image src="/homepage/icon-arrow-up.svg" alt="" fill className="object-contain" />
              </div>
            </Link>
